...
set CFLAGS=/nologo /c /TP /GS- /GF- /GR- /W3 /D_XBOX /D_XBOX360 /DNDEBUG
set LIBS=libcMT.lib libcpMT.lib xapilib.lib xboxkrnl.lib xnet.lib oldnames.lib

if "%CONFIG%"=="Debug" (
    set CFLAGS=/nologo /c /TP /GS- /GF- /GR- /W3 /D_XBOX /D_XBOX360 /D_DEBUG /Od
    set LIBS=libcMTD.lib libcpMTD.lib xapilibd.lib xboxkrnl.lib xnetd.lib oldnames.lib
)
...
link /nologo /NODEFAULTLIB:LIBCMT /NODEFAULTLIB:LIBCPMT /NODEFAULTLIB:LIBCI /NODEFAULTLIB:XAPI ^
    ...
    src\FTPServerConn.obj src\Shared.obj %LIBS%
if %ERRORLEVEL% NEQ 0 goto error
